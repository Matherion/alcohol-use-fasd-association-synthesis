...
Table 2 on page 598 show data on preliminary FAS diagnosis. Table 3 was preferred over Table 2.
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Smoking current",       ### Name of variable this result pertains to
  subsample = "Control mothers",                   ### Name of relevant subsample, or NA
  percentage = 28.6,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Smoking during",       ### Name of variable this result pertains to
  subsample = "Control mothers",                   ### Name of relevant subsample, or NA
  percentage = 26.8,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);


res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Smoking during same or more",       ### Name of variable this result pertains to
  subsample = "Case mothers",                   ### Name of relevant subsample, or NA
  percentage = 65.6,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Smoking during same or more",       ### Name of variable this result pertains to
  subsample = "Control mothers",                   ### Name of relevant subsample, or NA
  percentage = 17.2,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);


res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Current drinking",       ### Name of variable this result pertains to
  subsample = "Case mothers",                   ### Name of relevant subsample, or NA
  n = 53,
  mean = 12.6,
  sd = 13.1,
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Current drinking weekends",       ### Name of variable this result pertains to
  subsample = "Case mothers",                   ### Name of relevant subsample, or NA
  n = 53,
  mean = 11.1,
  sd = 11.1,
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  subsample = "Case mothers",                   ### Name of relevant subsample, or NA
  percentage = 92.5,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  subsample = "Case mothers",                   ### Name of relevant subsample, or NA
  percentage = 88.7,                  ### Percentage that endorsed 1, or NA
  comment = "extracted from table 3, page 599"                      ### Comment or NA
);
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  specificationTimeframe = "last year",  				 ### "per week", "per month", "per year"
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Used tobacco during index pregnancy (%)"                      ### Comment, as text; or NA
);

  res$variable[[length(res$variable) + 1]] <- list(
  variable = "Smoking during same or more",     ### Replace 'example' with variable name
  recodeToCategory = "Smoking during",
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "logical",             ### "numeric", "logical", "nominal", "ordinal", or "text"
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Tobacco use during index pregnancy, used same or more, than current use %"                ### Comment, as text; or NA
);
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "g per wk"                      ### Comment, as text; or NA
);
  

  res$variable[[length(res$variable) + 1]] <- list(
  variable = "Current drinking",     ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Current drinking weekends",     ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Drank before pregnancy with index child %"                      ### Comment, as text; or NA
);
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
 ...
 #specificationUnits = NA,           			 ### "ml", "mg", "oz"
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Drank during index pregnancy %"                      ### Comment, as text; or NA
);
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Drank during index pregnancy 1st trimester %"                      ### Comment, as text; or NA
);
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Drank during index pregnancy 2nd trimester %"                      ### Comment, as text; or NA
); 
...
####################################### ONLY FOR MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  aboutAlcoholism = FALSE,				### TRUE if the variable is about alcoholism
  description = NA,                 ### Description, as text; or NA
  comment = "Table 3, p. 599. Drank during index pregnancy 3rd trimester %"                      ### Comment, as text; or NA
);
